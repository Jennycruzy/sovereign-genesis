...
export default function Header({ lastUpdated }) {
  ...
  return (
    <header
      className={`relative border-b backdrop-blur-sm px-6 py-4 transition-colors duration-300 ${
        isDark
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <div
              className={`h-10 w-10 rounded-lg flex items-center justify-center text-lg font-bold shadow-lg transition-colors duration-300 ${
                isDark
            ...
            <div
              className="absolute -top-0.5 -right-0.5 h-2.5 w-2.5 rounded-full bg-emerald-400 border-2 animate-pulse"
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <div
            className={`h-3 w-px ${
              isDark ? "bg-slate-700" : "bg-light-border"
            }`}
          />
          <span className={isDark ? "text-slate-500" : "text-light-muted"}>
            Updated:{" "}
            <span className={isDark ? "text-slate-400" : "text-light-text"}>
              {time}
            </span>
          </span>
          <div
